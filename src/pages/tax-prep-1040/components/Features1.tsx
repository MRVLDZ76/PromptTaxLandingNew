...
const Features1 = () => {
    const features = [
        {
            title: 'AIY Paradigm - AI Works for You',
            description: 'Unlike traditional DIY software where you work for the machine, PromptTax flips the script. Tell AI your tax story in plain English, upload documents, and let the system handle the complex work with 99%+ accuracy.'
        },
        {
            title: 'Document Intelligence Engine',
            description: 'Upload W-2s, 1099s, K-1s, receipts, and statements. AI extracts, validates, and populates your 1040 automatically. No manual data entry required.'
        },
        {
            title: 'Crypto Automation & Wash Sale Logic',
            description: 'Auto-sync with 11+ exchanges (Coinbase, Binance, Kraken), DeFi protocols, and NFT marketplaces. Built-in wash sale detection and cost basis tracking ensures IRS compliance.'
        },
        {
            title: 'Natural Language Tax Chat',
            description: 'Ask questions in plain English: "How do I deduct my home office?" or "What about my crypto losses?" AI guides you through complex scenarios without tax jargon.'
        },
        {
            title: 'Affordable CPA Review & E-Filing',
            description: 'AI does 99% of the work. Licensed CPAs review your completed return and e-file directly for a fraction of traditional CPA costs. Get professional oversight without the premium price.'
        },
        {
            title: 'Export Portability & IRS Compliance',
            description: 'Export to TurboTax, H&R Block, or any tax software. Full IRS compliance, audit support, and Schedule C/E/K-1 integration included.'
        }
    ];

    const statData: Array<{stat: number, prefix?: string, suffix?: string, title: string}> = [
        {
            stat: 99,
            suffix: '%',
            title: 'Accuracy Rate'
                ...
                <Row className="align-items-start">
                    ...
                    <Col lg={6} xl={5} className="position-relative text-center order-1 mt-6 mt-lg-0">
                        ...
                        <div
                            ...
                            <h3 className="text-white mb-0">1040 Forms</h3>
                            <p className="mb-0">Schedule C (Business)</p>
                            <p className="mb-0">Schedule E (Rental)</p>
                            <p className="mb-0">Schedule D (Capital Gains)</p>
                            <p className="mb-0">Crypto & K-1 Integration</p>
                        </div>

                        <img src="/default.png" className="rounded position-relative" alt="1040 tax preparation"/>
                    </Col>

                    <Col lg={6} className="ms-auto position-relative order-lg-2">
                        <h2 className="mb-4 mb-md-5">AI-Powered 1040 Tax Filing</h2>
                        <p className="mb-4 mb-md-5">Let AI handle the complexity of your 1040 return with document intelligence, crypto automation, and natural language guidance. Get CPA review and e-filing without the premium price.</p>
