          ...
          <Col lg={6} className="mb-6 mb-lg-0">
            <div className="d-flex flex-column h-100">
              ...
              <p className="mb-0">Watch how intelligent document processing transforms photos and scans into filing-ready data. 
                <br /><br />Cut data entry time by 95% and catch deductions that human eyes might miss. 
                <br /><br />You can reach us anytime via <Link to="mailto:hi@prompt.tax">hi@prompt.tax</Link></p>
                  ...
                  {followUsIcons.map((item, idx) => {
                    ...
                    return (
                      <li className="list-inline-item" key={idx}>
                        <Link to={item.link ?? ""} className={`btn btn-icon btn-light rounded-circle ${item.variant}`}><Icon /></Link>
                      </li>
                    )
                  })}
                </ul>
