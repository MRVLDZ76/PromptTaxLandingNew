        ...
        <Row className="g-4 g-sm-5">
          <Col lg={5}>
            ...
            <div className="text-center d-inline-block bg-light border rounded position-relative px-5 py-3">
              <span className="heading-color">Work with us?</span> <Link className="stretched-link ms-2" to="/contact/v2">Join our community<BsChevronRight className="small ms-1" /></Link>
            </div>
          </Col>
