                ...
                <div className="bg-dark rounded position-relative overflow-hidden p-4 p-sm-7">
                    ...
                    <Row className="g-4 position-relative">
                        ...
                        <Col lg={10} xl={7} className="mx-auto text-center">
                            <h3 className="text-white mb-3">Ready to file with confidence?</h3>
                            <p className="text-white opacity-8">Get started with AI-powered tax preparation and expert CPA review. Join thousands of taxpayers who trust PromptTax for accurate, stress-free filing.</p>
                            <a href="#" onClick={openModal} className="btn btn-primary mb-md-5">Start Your Return Now</a>
                        </Col>
