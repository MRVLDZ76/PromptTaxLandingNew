    ...
    return (
        <Card className={`p-0 border ${plan.isPopular ? 'border-primary' : 'shadow'}`}>
            ...
            <Card.Header
                ...
                <p className="mb-0"><span className="h2 mb-0 plan-price">{currency}{plan.price}</span></p>
                <small>Per tax return filing</small>
            </Card.Header>
            ...
            <Card.Body className={`p-4 ${plan.isPopular ? 'bg-primary bg-opacity-10' : ''}`}>
                <div className="text-center text-lg-start">
                    ...
                    <a href="#" onClick={openModal} className={`btn  w-100 ${plan.isPopular ? 'btn-primary mb-0' : 'btn-dark'}`}>Get
                        started</a>
                </div>
            </Card.Body>
