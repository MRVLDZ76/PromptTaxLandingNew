...
const Hero = () => {
    ...
    const [planDuration] = useState<'month' | 'year'>('month')
        ...
        <section className="pt-0">
            ...
            <div className="bg-dark position-relative pt-8 pt-xl-9 pb-7 pb-sm-8 px-4 px-md-0 overflow-hidden">
                ...
                <div className="inner-container-small text-center position-relative mb-8">
                    ...
                    <h1 className="text-white mb-4">Choose Your CPA Review Level</h1>
                    <p className="text-white opacity-9 mb-5 lead">Get peace of mind with expert CPA review before filing. Whether you have a straightforward return or complex tax situation with crypto, K-1s, and multi-state income, our licensed CPAs provide thorough review and professional e-filing options tailored to your needs.</p>
