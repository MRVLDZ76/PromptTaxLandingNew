        ...
        <Row className="g-4 align-items-xl-center">
          <Col lg={7}>
            <Row className="pe-xl-5">
              <Col sm={6}>
                <img src={about02} className="rounded" alt="about" />
              ...
              <Col sm={6}>
                ...
                <img src={about01} className="rounded" alt="about" />
              </Col>
            </Row>
            {" "}
          </Col>
          ...
          <Col lg={5}>
            ...
            <h2 className="my-4">Traditional vs. PromptTax</h2>
            <p className="mb-4">
              Self-Service K-1Process your own Schedule K-1 forms with professional-grade tools</p>
