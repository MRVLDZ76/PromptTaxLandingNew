                ...
                <Row className="align-items-start">
                    ...
                    <Col lg={6} xl={5} className="position-relative text-center order-1 mt-6 mt-lg-0">
                        ...
                        <div
                            ...
                            <h3 className="text-white mb-0">K1- data</h3>
                            <p className="mb-0">Schedule E (Part II)</p>
                            <p className="mb-0">Form 6198</p>
                            <p className="mb-0">Form 8582</p>
                            <p className="mb-0">Form 1040 integration</p>
                        </div>
 

                        <img src="/images/marketing/k1styled.jpg.png" className="rounded position-relative" alt="about-img"/>
                    </Col>


                    <Col lg={6} className="ms-auto position-relative order-lg-2">
                        <h2 className="mb-4 mb-md-5">Quick and Effective K-1 Processing</h2>
                        <p className="mb-4 mb-md-5">Efficiently process your K-1 forms with AI-powered data extraction, identifying and resolving issues swiftly to ensure accurate tax filing.</p>
