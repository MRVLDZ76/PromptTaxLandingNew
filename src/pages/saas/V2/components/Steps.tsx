...
import { BsArrowRight, BsDisplay, BsPatchCheck, BsPhone, BsShieldLock, BsCloudUpload, BsFileEarmarkPdf, BsLightning, BsCheckCircle, BsDownload, BsPeople } from "react-icons/bs";
        ...
        <section className="pb-0 overflow-hidden">
            <Container>
                ...
                <div className="inner-container-small text-center mb-4 mb-sm-6">
                    ...
                    <h2 className="mb-0 mt-3">From data upload to tax filing in 3 simple steps</h2>
                </div>
                        ...
                        <Row className="flex-lg-nowrap align-items-center position-relative mb-8">
                            ...
                            <Col lg={7}>
                                <div className="bg-light rounded px-5 ps-md-6 py-7 pe-md-8">
                                    ...
                                    <h4 className="mb-4">Upload your crypto & K-1 data</h4>
                                    <p className="mb-4">Connect exchanges, import K-1 forms, or upload transaction history. Our AI securely processes your data in minutes.</p>

                                    <ul className="list-group list-group-borderless mb-4">
                                        <li className="list-group-item heading-color d-flex mb-0 icons-center">
                                            <BsPatchCheck className="text-primary me-2"/>Connect 150+ exchanges via API
                                        </li>
                                        <li className="list-group-item heading-color d-flex mb-0 icons-center">
                                            <BsPatchCheck className="text-primary me-2"/>Import partnership K-1 PDFs
                                        </li>
                                        <li className="list-group-item heading-color d-flex mb-0 icons-center">
                                            <BsPatchCheck className="text-primary me-2"/>Bank-level encryption
                                        </li>
                                    </ul>

                                    <Link to="/pricing" className="btn btn-dark icon-link icon-link-hover">Start upload
                            ...
                            <Col lg={7} xs={11} className="ms-lg-n8 mx-auto mt-n5 mt-lg-0">
                                <div className="bg-white shadow rounded p-4 overflow-hidden ms-3">
                                    {/* Upload Interface Visual */}
                                    <div className="bg-light rounded p-4 mb-3 text-center">
                                        <BsCloudUpload size={48} className="text-primary mb-3"/>
                                        <h6 className="mb-2">Drag & drop files or click to browse</h6>
                                        <p className="small text-muted mb-0">CSV, XLSX, PDF supported</p>
                                    </div>
                                    
                                    {/* Exchange Logos */}
                                    <div className="mb-3">
                                        <p className="small text-muted mb-2">Connected Exchanges</p>
                                        <div className="d-flex gap-2 flex-wrap">
                                            <div className="bg-light rounded p-2" style={{width: '50px', height: '50px'}}>
                                                <img src={binanceLogo} alt="Binance" className="w-100 h-100" style={{objectFit: 'contain'}}/>
                                            </div>
                                            <div className="bg-light rounded p-2" style={{width: '50px', height: '50px'}}>
                                                <img src={coinbaseLogo} alt="Coinbase" className="w-100 h-100" style={{objectFit: 'contain'}}/>
                                            </div>
                                            <div className="bg-light rounded p-2" style={{width: '50px', height: '50px'}}>
                                                <img src={krakenLogo} alt="Kraken" className="w-100 h-100" style={{objectFit: 'contain'}}/>
                                            </div>
                                            <div className="bg-light rounded p-2" style={{width: '50px', height: '50px'}}>
                                                <img src={geminiLogo} alt="Gemini" className="w-100 h-100" style={{objectFit: 'contain'}}/>
                                            </div>
                                            <div className="bg-light rounded p-2" style={{width: '50px', height: '50px'}}>
                                                <img src={metamaskLogo} alt="MetaMask" className="w-100 h-100" style={{objectFit: 'contain'}}/>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="bg-primary bg-opacity-10 rounded p-3 mb-3">
                                        <div className="d-flex align-items-center">
                                            <BsFileEarmarkPdf size={32} className="text-primary me-3"/>
                                            <div>
                                                <h6 className="mb-0">Schedule K-1.pdf</h6>
                                                <small className="text-muted">2.4 MB • Uploaded</small>
                                            </div>
                                            <BsCheckCircle size={24} className="text-success ms-auto"/>
                                        </div>
                                    </div>
                                    ...
                                    <div className="d-flex align-items-center justify-content-center gap-2 text-muted">
                                        ...
                                        <small>256-bit AES encryption</small>
                                    </div>
                                </div>
                            </Col>
                        </Row>
                        ...
                        <Row className="flex-lg-nowrap align-items-center position-relative mb-8">
                            ...
                            <Col lg={7} xs={11}
                                ...
                                <Card className="card-body shadow rounded p-4 overflow-hidden me-3">
                                    ...
                                    <div className="bg-primary bg-opacity-10 rounded p-4 mb-3 text-center">
                                        ...
                                        <small className="text-muted">Calculating cost basis...</small>
                                    </div>
                                    ...
                                    <Row className="g-3 mb-3">
                                        <Col xs={6}>
                                            <div className="bg-light rounded p-3 text-center">
                                                <h3 className="text-primary mb-1">30<small>sec</small></h3>
                                                <small className="text-muted">Processing time</small>
                                            </div>
                                        </Col>
                                        <Col xs={6}>
                                            <div className="bg-light rounded p-3 text-center">
                                                <h3 className="text-primary mb-1">99.8<small>%</small></h3>
                                    ...
                                    <div className="bg-success bg-opacity-10 rounded p-3">
                                        <div className="d-flex align-items-center justify-content-between mb-2">
                                            <div className="d-flex align-items-center gap-2">
                                                ...
                                                <small className="fw-bold">Form 8949 generated</small>
                                            </div>
                                            <small className="text-muted">2 pages</small>
                                        </div>
                                        <div className="d-flex align-items-center justify-content-between mb-2">
                                            <div className="d-flex align-items-center gap-2">
                                                <BsCheckCircle className="text-success"/>
                                                <small className="fw-bold">Schedule D generated</small>
                                            </div>
                                            <small className="text-muted">1 page</small>
                                        </div>
                                        <div className="d-flex align-items-center justify-content-between">
                                            <div className="d-flex align-items-center gap-2">
                                                <BsCheckCircle className="text-success"/>
                                                <small className="fw-bold">Schedule K-1 generated</small>
                                            </div>
                                            <small className="text-muted">3 pages</small>
                                        </div>
                                    </div>
                                </Card>
                            </Col>
                            ...
                            <Col lg={7} className="order-1 order-lg-2">
                                <div className="bg-light rounded py-7 px-5 pe-md-6 ps-md-8">
                                    ...
                                    <h4 className="mb-4">AI generates your complete tax return</h4>
                                    <p className="mb-4">Our AI calculates cost basis, tax loss harvesting, K-1 distributions, and generates IRS-ready forms automatically.</p>

                                    <Row className="row-cols-2 g-4 mb-5">
                                        <Col>
                                            <div className="d-flex">
                                                <h4 className="purecounter mb-0">
                                                    <CountUp end={30} delay={0.3}/>
                                                </h4>
                                                <span className="h4 text-primary mb-0">sec</span>
                                            </div>
                                            <p className="mb-0 heading-color">Average processing time</p>
                                        </Col>

                                        <Col>
                                            <div className="d-flex">
                                                <h4 className="purecounter mb-0">
                                                    <CountUp end={99.8} delay={0.3} decimals={1}/>
                                                </h4>
                                                <span className="h4 text-primary mb-0">%</span>
                                            </div>
                                            <p className="mb-0 heading-color">Accuracy rate</p>
                                        </Col>
                                    </Row>

                                    <Link className="btn btn-dark icon-link icon-link-hover" to="/pricing">See how it works
                                        <BsArrowRight className='bi'/>
                                    </Link>
                                </div>
                            </Col>
                        ...
                        <Row className="flex-lg-nowrap align-items-center">
                            ...
                            <Col lg={7}>
                                <div className="bg-light rounded px-5 ps-md-6 py-7 pe-md-8">
                                    ...
                                    <h4 className="mb-3">Choose your filing option</h4>
                                    <p>Download and file yourself, get CPA review, or let our licensed CPA team handle everything.</p>
                                    ...
                                    <ul className="list-group list-group-borderless mb-4">
                                        ...
                                        <li className="list-group-item d-flex mb-0">
                                            ...
                                            <div className="ms-3">
                                                <p className="heading-color fw-bold mb-0">CPA Review ($149)</p>
                                                <small>Licensed CPA reviews + IRS e-filing</small>
                                            </div>
                                        </li>
                                    </ul>

                                    <Link className="btn btn-dark icon-link icon-link-hover" to="/pricing">View pricing
                                        <BsArrowRight className='bi'/>
                                    </Link>
                                </div>
                            </Col>
                            ...
                            <Col xs={11} lg={7} className="ms-lg-n8 mx-auto mt-n5 mt-lg-0">
                                <div className="bg-white shadow rounded p-4 overflow-hidden ms-3">
                                    ...
                                    <Card className="border-2 border-primary mb-3">
                                        <Card.Body className="p-3">
                                            ...
                                            <small className="text-muted d-block mb-3">Download instantly and file yourself</small>
                                            <div className="d-flex gap-2">
                                                <BsCheckCircle className="text-success flex-shrink-0 mt-1" size={14}/>
                                                <small>All tax forms generated</small>
                                            </div>
                                            <div className="d-flex gap-2">
                                                <BsCheckCircle className="text-success flex-shrink-0 mt-1" size={14}/>
                                                <small>IRS-ready PDFs</small>
                                            </div>
                                        </Card.Body>
                                    </Card>
                                    
                                    <Card className="border-2 border-success mb-3">
                                        <Card.Body className="p-3">
                                            <div className="d-flex align-items-start justify-content-between mb-2">
                                                <div>
                                                    <h6 className="mb-1">CPA Review</h6>
                                                    <h4 className="text-success mb-0">$149</h4>
                                                </div>
                                                <BsPeople size={24} className="text-success"/>
                                            </div>
                                            <small className="text-muted d-block mb-3">Licensed CPA reviews + IRS e-filing</small>
                                            <div className="d-flex gap-2">
                                                <BsCheckCircle className="text-success flex-shrink-0 mt-1" size={14}/>
                                                <small>Everything in Self-Service</small>
                                            </div>
                                            <div className="d-flex gap-2">
                                                <BsCheckCircle className="text-success flex-shrink-0 mt-1" size={14}/>
                                                <small>Licensed CPA verification</small>
                                            </div>
                                            <div className="d-flex gap-2">
                                                <BsCheckCircle className="text-success flex-shrink-0 mt-1" size={14}/>
                                                <small>Direct IRS e-filing</small>
                                            </div>
                                        </Card.Body>
                                    </Card>
                                    
                                    <div className="bg-light rounded p-3 text-center">
                                        <small className="text-muted">✓ 100% satisfaction guaranteed</small>
                                    </div>
                                </div>
                            </Col>
                        </Row>
