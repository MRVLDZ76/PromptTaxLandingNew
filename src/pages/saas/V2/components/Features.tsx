...
import binanceLogo from '/brands/6177df9fedaa6b2504d1f3d2_Binance.avif'
import coinbaseLogo from '/brands/63e2f3ae88285e1b2db54792_Coinbase Icon.svg'
import krakenLogo from '/brands/6177e819ff4246e1e50138d9_Kraken.avif'
import geminiLogo from '/brands/gemini.avif'
import metamaskLogo from '/brands/6177e8e96f89317ea04c2158_MetaMask.avif'
...
The intelligent bridge between documents and tax returns</h2>
                </div>
                ...
                <Tab.Container defaultActiveKey="crypto">
                    <Row>
                        <Col lg={10} xl={8} xxl={6} className="mx-auto mb-6 mb-xl-8">
                            <div className="bg-light rounded-pill p-2">
                                <Nav variant='pills'
                                    ...
                                    <Nav.Item>
                                        <Nav.Link eventKey='crypto' className="nav-link rounded-pill">
                                            <BsFunnel className="me-2"/>Crypto Tax
                                        </Nav.Link>
                                    </Nav.Item>

                                    <Nav.Item>
                                        <Nav.Link eventKey='k1' className="rounded-pill">
                                            <BsBasket className="me-2"/>K-1 Forms
                                        </Nav.Link>
                                    </Nav.Item>

                                    <Nav.Item>
                                        <Nav.Link eventKey='form1040' className="rounded-pill">
                                            <BsGear className="me-2"/>Form 1040
                                        </Nav.Link>
                                    </Nav.Item>

                                    <Nav.Item>
                                        <Nav.Link eventKey='cpa' className="rounded-pill">
                                            <BsPieChart className="me-2"/>CPA Review
                                        </Nav.Link>
                                    </Nav.Item>
                        ...
                        <Col xs={11} className="mx-auto">
                            <Tab.Content>
                                <Tab.Pane eventKey='crypto' className="fade">
                                    <Row className="align-items-center">

                                        <Col lg={6} className="mb-6 mb-lg-0">
                                        <span
                                            className="bg-primary bg-opacity-10 text-primary text-uppercase rounded small px-3 py-2">Crypto Tax Automation</span>
                                            <h3 className="my-4">Complete Cryptocurrency Tax Filing</h3>
                                            <p>Automate your crypto tax reporting with AI-powered transaction imports from 15+ exchanges. Calculate capital gains, track DeFi rewards, and generate IRS Form 8949 & Schedule D.</p>

                                            <ul className="list-group list-group-borderless mb-4">
                                                <li className="list-group-item heading-color mb-0 icons-center">
                                                    <BsPatchCheckFill className="text-primary me-2"/>Multi-exchange aggregation
                                                </li>
                                                <li className="list-group-item heading-color mb-0 icons-center">
                                                    <BsPatchCheckFill className="text-primary me-2"/>Cost basis tracking (FIFO/LIFO/HIFO)
                                                </li>
                                                <li className="list-group-item heading-color mb-0 icons-center">
                                                    <BsPatchCheckFill className="text-primary me-2"/>Tax loss harvesting alerts
                                                </li>
                                            </ul>

                                            <Link className="btn btn-white icon-link icon-link-hover" to="/crypto-tax">Explore
                                                crypto tax<BsArrowRight/> </Link>
                                        </Col>
                                        ...
                                        <Col lg={4} className="position-relative ms-auto">
                                            ...
                                            <Card
                                                ...
                                                <div className="d-flex align-items-center">
                                                    ...
                                                    <h6 className="text-white mb-0 ms-2">150+</h6>
                                                </div>
                                                <hr/>
                                                ...
                                                <div className="overflow-hidden">
                                                    ...
                                                    <ProgressBar now={99} variant="primary" style={{ width: "100%", height: "5px" }} />
                                                </div>
                                            </Card>
                                        </Col>
                                    </Row>
                                ...
                                <Tab.Pane eventKey='k1' className="fade">
                                    <Row className="align-items-center">

                                        <Col lg={6} className="mb-6 mb-lg-0">
                                        <span
                                            className="bg-primary bg-opacity-10 text-primary text-uppercase rounded small px-3 py-2">K-1 Form Generation</span>
                                            <h3 className="my-4">Partnership K-1 Forms Made Simple</h3>
                                            <p className="mb-5">Generate Schedule K-1 forms for partnerships and S-corps automatically. AI calculates distributions, basis adjustments, and tax allocations with 100% accuracy.</p>

                                            <Row className="g-4 mb-5">
                                                <Col sm={6}>
                                                    <p className="heading-color icons-center mb-3">
                                                        <BsDiagram3 size={24} className="fa-xl text-primary me-3"/>Auto-calculate distributions</p>
                                                    <p className="heading-color icons-center mb-0">
                                                        <BsBoxes size={24} className="fa-xl text-primary me-3"/>Basis adjustments
                                                        </p>
                                                </Col>

                                                <Col sm={6}>
                                                    <p className="heading-color icons-center mb-3">
                                                        <BsPeople size={24} className="fa-xl text-primary me-3"/>Unlimited partners
                                                        </p>
                                                    <p className="heading-color icons-center mb-0">
                                                        <BsShieldCheck size={24} className="fa-xl text-primary me-3"/>IRS-compliant forms</p>
                                                </Col>
                                            </Row>

                                            <Link className="btn btn-white icon-link icon-link-hover" to="/k1-forms">Explore
                                                K-1 automation<BsArrowRight className='bi'/> </Link>
                                        </Col>
                                        ...
                                        <Col lg={4} className="position-relative ms-auto">
                                            ...
                                            <Col md={8}
                                                ...
                                                <div className="bg-body rounded p-3">
                                                    <div
                                                        ...
                                                        <p className="heading-color mb-0 ms-2">Import partnership data automatically</p>
                                                    </div>
                                                    ...
                                                    <div
                                                        ...
                                                        <p className="heading-color mb-0 ms-2">Generate all partner K-1s instantly</p>
                                                    </div>
                                                    ...
                                                    <div
                                                        ...
                                                        <p className="heading-color mb-0 ms-2">IRS-ready PDF downloads</p>
                                                    </div>
                                            ...
                                            <img src={about14K1} className="rounded" alt="feature-img"/>
                                        </Col>
                                    </Row>
                                </Tab.Pane>

                                <Tab.Pane eventKey='form1040' className="fade">
                                    <Row className="align-items-center">

                                        <Col lg={6} className="mb-6 mb-lg-0">
                                        <span
                                            className="bg-primary bg-opacity-10 text-primary text-uppercase rounded small px-3 py-2">Form 1040 Integration</span>
                                            <h3 className="my-4">Seamless 1040 Tax Return Filing</h3>
                                            <p>Automatically integrate crypto gains and K-1 income into your Form 1040. AI populates Schedule D, Schedule E, and supporting forms with perfect accuracy.</p>

                                            <ul className="list-group list-group-borderless mb-4">
                                                <li className="list-group-item heading-color mb-0 icons-center">
                                                    <BsPatchCheckFill className="text-primary me-2"/>Auto-populate Schedule D & E
                                                </li>
                                                <li className="list-group-item heading-color mb-0 icons-center">
                                                    <BsPatchCheckFill className="text-primary me-2"/>Direct IRS e-file integration
                                                </li>
                                                <li className="list-group-item heading-color mb-0 icons-center">
                                                    <BsPatchCheckFill className="text-primary me-2"/>State tax return support
                                                </li>
                                            </ul>

                                            <Link className="btn btn-white icon-link icon-link-hover" to="/tax-prep-1040">Explore
                                                1040 filing<BsArrowRight/> </Link>
                                        </Col>
                                        ...
                                        <Col lg={4} className="position-relative ms-auto">
                                            ...
                                            <div
                                                ...
                                                <p className="text-dark fw-bold mb-0">E-File Ready</p>
                                            ...
                                            <Card
                                                className="card-body position-absolute bottom-0 start-0 ms-lg-n8 mb-n5">
                                                <p>IRS Acceptance Rate</p>
                                                <div className="d-flex align-items-center">
                                                    <h6 className="text-white mb-0 ms-2">99.8%</h6>
                                                </div>
                                                <hr/>

                                                <div className="overflow-hidden">
                                                    <div className="d-flex justify-content-between mb-2">
                                                        <small>First-Time Acceptance</small>
                                                        <small>98%</small>
                                                    </div>
                                                    <ProgressBar now={98} variant="primary" style={{ width: "100%", height: "5px" }} />
                                                </div>
                                            </Card>
                                        </Col>
                                    </Row>
                                ...
                                <Tab.Pane eventKey='cpa' className="fade">
                                    <Row className="align-items-center">

                                        <Col lg={6} className="mb-6 mb-lg-0">
                                        <span
                                            className="bg-primary bg-opacity-10 text-primary text-uppercase rounded small px-3 py-2">CPA Review Service</span>
                                            <h3 className="my-4">Licensed CPA Review & Filing</h3>
                                            <p className="mb-5">Every return is reviewed by licensed CPAs before filing. Get expert verification, tax optimization recommendations, and audit support for complete peace of mind.</p>

                                            <Row className="g-4 mb-5">
                                                <Col sm={6}>
                                                    <p className="heading-color icons-center mb-3">
                                                        <BsDiagram3 size={24} className="fa-xl text-primary me-3\"/>CPA verification
                                                    </p>
                                                    <p className="heading-color icons-center mb-0">
                                                        <BsBoxes size={24} className="fa-xl text-primary me-3\"/>Tax optimization
                                                        </p>
                                                </Col>

                                                <Col sm={6}>
                                                    <p className="heading-color icons-center mb-3">
                                                        <BsPeople size={24} className="fa-xl text-primary me-3\"/>30-min consultation
                                                        </p>
                                                    <p className="heading-color icons-center mb-0">
                                                        <BsShieldCheck size={24} className="fa-xl text-primary me-3\"/>Audit protection</p>
                                                </Col>
                                            </Row>

                                            <Link className="btn btn-white icon-link icon-link-hover" to="/pricing">Explore
                                                CPA review<BsArrowRight className='bi'/> </Link>
                                        </Col>
                                        ...
                                        <Col lg={4} className="position-relative ms-auto">
                                            ...
                                            <Col md={8}
                                                ...
                                                <div className="bg-body rounded p-3">
                                                    <div
                                                        ...
                                                        <p className="heading-color mb-0 ms-2">CPA verifies all calculations and forms</p>
                                                    </div>
                                                    ...
                                                    <div
                                                        ...
                                                        <p className="heading-color mb-0 ms-2">Tax-saving strategies identified</p>
                                                    </div>
                                                    ...
                                                    <div
                                                        ...
                                                        <p className="heading-color mb-0 ms-2">Audit support included</p>
                                                    </div>
                                            ...
                                            <div
                                                ...
                                                <div className="d-flex align-items-center">
                                                    <img src={trustStarImg}
                                                         className="h-30px" alt="rating-img"/>
                                                    <h6 className="font-base fw-bold heading-color ms-1 mb-0">4.9/5.0</h6>
                                                </div>
                                                <p className="text-dark small mb-0 mt-2">CPA Service Rating</p>
                                            </div>
                                            ...
                                            <img src={about19} className="rounded" alt="feature-img"/>
                                        </Col>
                                    </Row>
                                </Tab.Pane>
                            </Tab.Content>
