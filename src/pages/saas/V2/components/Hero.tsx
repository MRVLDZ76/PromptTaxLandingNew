...
import ChatInterfaceCard from '@/components/ChatInterfaceCard'
import K1DocumentCard from '@/components/K1DocumentCard'
                ...
                <Row className="justify-content-xl-start justify-content-center flex-xl-nowrap">
                    <Col xl={6} className="ps-xl-5 mb-8 mb-xl-0">
                        ...
                        <div className="d-flex gap-3 gap-sm-4 flex-wrap mt-4 mt-md-5">
                            ...
                            <Link className="icon-link icon-link-hover heading-color text-primary-hover mb-0" to="/contact/v2">Contact
                        ...
                        <Row className="g-4">
                            <Col sm={6}>
                                ...
                                <p className="mb-0">Total score <span
                                    ...
                                    className="fw-bold heading-color"> 850 reviews</span></p>
                            </Col>
                            ...
                            <Col sm={6}>
                                ...
                                <p className="mb-0">Total score <span
                                    className="text-secondary text-opacity-25">|</span><span
                                    className="fw-bold heading-color"> 620 reviews</span></p>
                            </Col>
                        </Row>
                    </Col>
                    ...
                    <Col xl={10} className="d-flex rotate-343 position-relative aos z-index-2" data-aos="zoom-in-up"
                        ...
                        <Parallax>
                            ...
                            <div className="position-relative" style={{ minHeight: '700px', width: '100%' }}>
                                
                                {/* Top Right: Security Card */}
                                <div data-depth="0.5" className="layer position-absolute" style={{ 
                                    top: '0', 
                                    right: '40px', 
                                    zIndex: 10 
                                }}>
                                ...
                                {/* Left Side: Transaction Sync Card */}
                                <div data-depth="0.7" className="layer position-absolute d-none d-xl-block" style={{ 
                                    top: '100px',
                                    left: '0',
                                    zIndex: 8
                                }}>
                                ...
                                {/* Center: Main Dashboard (Black Background) */}
                                ...
                                {/* Right Middle: Chat Interface */}
                                <div data-depth="0.6" className="layer position-absolute d-none d-lg-block" style={{ 
                                    top: '280px', 
                                    right: '0',
                                    zIndex: 9 
                                }}>
                                ...
                                {/* Bottom Left: K1 Document */}
                                <div data-depth="0.4" className="layer position-absolute d-none d-md-block" style={{ 
                                    bottom: '0',
                                    left: '60px',
                                    zIndex: 7
                                }}>
