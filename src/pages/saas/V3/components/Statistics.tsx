...
import decoration6 from '@/assets/images/elements/saas-decoration/05.png'
                ...
                <Row className="g-4">
                    <Col xl={7} className="position-relative pe-xl-4 order-2">
                        ...
                        <Row className="position-relative">
                            ...
                            <Col sm={6}>
                                <img src="/images/marketing/14.jpg" className="shadow rounded-4" alt="About-img"/>
                            </Col>
                        </Row>
                    ...
                    <Col xl={5} className="order-1 order-xl-2 ms-auto">
                        <h2 className="mb-4 mb-xl-5">Trusted by CPAs and Tax Professionals</h2>
                        <p className="mb-4 mb-xl-5">Join thousands of accounting professionals using PromptTax to save time, reduce errors, and deliver faster results to clients.</p>
                        ...
                        <div className="avatar avatar-xl flex-shrink-0 d-flex align-items-center justify-content-center bg-primary text-white rounded-circle" style={{ width: 64, height: 64, fontSize: 28, fontWeight: 600 }}>
                              SC
                        </div>
                            <div className="ms-3">
                                <p className="fs-6 fw-normal heading-color mb-4">"PromptTax cut our K-1 preparation time from 8 hours to 45 minutes per client. Game changer."</p>
